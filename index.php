...
if (!file_exists(GLPI_CONFIG_DIR . "/config_db.php")) {
   ...
   echo '<head><title>'.__('Iniciar sesión - Plataforma de gestion de tickets').'</title>'."\n";
   ...
   echo "<div id='text-login' style='color: #000;'>";
   echo /*nl2br(Toolbox::unclean_html_cross_side_scripting_deep($CFG_GLPI['text_login']))*/ "<p>Plataforma de gestion de tickets<p>";
   echo "</div>";
   ...
   if ($CFG_GLPI["login_remember_time"]) {
      echo '<p class="login_input">
            <label for="login_remember" style="color: #000;">
