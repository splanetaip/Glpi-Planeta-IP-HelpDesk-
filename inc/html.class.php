...
JAVASCRIPT;
   ...
   **/
   ...
   static function getCopyrightMessage($withVersion = true) {
      $message = "<a href=\"https://planetaip.co/\" title=\"Powered by Teclib and contributors\" class=\"copyright\" style='color: #000;'>";
      $message .= "2022 ";
      // if required, add GLPI version (eg not for login page)
      if ($withVersion) {
          $message .= GLPI_VERSION . " ";
      }
      $message .= "Copyright " /*. GLPI_YEAR .*/ . "Planeta IP Powered by Teclib and contributors".
         "</a>";
      return $message;
   }
